...
void CSelectScene::SpellInitialize()
{
	...
	*/	
	...
	m_vecSpell.push_back(new CSpell_("Cleanse", "Resource/choen/Spell_Image/Exhaust.png", D3DXVECTOR3(530, 500, 0), D3DXVECTOR3(0.5f, 0.5f, 0.5f)));
	m_vecSpell.push_back(new CSpell_("Cleanse", "Resource/choen/Spell_Image/Flash.png",   D3DXVECTOR3(580, 500, 0), D3DXVECTOR3(0.5f, 0.5f, 0.5f)));
	m_vecSpell.push_back(new CSpell_("Cleanse", "Resource/choen/Spell_Image/Ghost.png",   D3DXVECTOR3(630, 500, 0), D3DXVECTOR3(0.5f, 0.5f, 0.5f)));
	m_vecSpell.push_back(new CSpell_("Cleanse", "Resource/choen/Spell_Image/Heal.png",    D3DXVECTOR3(480, 570, 0), D3DXVECTOR3(0.5f, 0.5f, 0.5f)));
	m_vecSpell.push_back(new CSpell_("Cleanse", "Resource/choen/Spell_Image/Smite.png",   D3DXVECTOR3(530, 570, 0), D3DXVECTOR3(0.5f, 0.5f, 0.5f)));
	m_vecSpell.push_back(new CSpell_("Cleanse", "Resource/choen/Spell_Image/Teleport.png",D3DXVECTOR3(580, 570, 0), D3DXVECTOR3(0.5f, 0.5f, 0.5f)));
	m_vecSpell.push_back(new CSpell_("Cleanse", "Resource/choen/Spell_Image/Ignite.png",  D3DXVECTOR3(630, 570, 0), D3DXVECTOR3(0.5f, 0.5f, 0.5f)));
	m_vecSpell.push_back(new CSpell_("Cleanse", "Resource/choen/Spell_Image/Barrier.png", D3DXVECTOR3(480, 640, 0), D3DXVECTOR3(0.5f, 0.5f, 0.5f)));
	m_mapUI_List.insert(make_pair("Spel", &m_vecSpell));
